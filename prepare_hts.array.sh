...
VCF_PATH=/nemo/project/proj-tracerx-lung/tracerx/_RELEASE/release_tx842/${PATIENT}/germline/vcf/${GL_NAME}.soft-filter.vcf.gz
BAM_PATH=/nemo/project/proj-tracerx-lung/datasets/tracerx/alignments/wes/v2/bam
...
python generate_loci_allele_files.py --input_vcf ${VCF_PATH} \
                                     --loci_input input/G1000_allelesAll_hg19/ \
